...
author: Jason Ma
cover: 'https://cdn.nlark.com/yuque/__latex/a61e6af3dd1a084803ca60014e97e1ea.svg'
description: '---title: 3D数学基础 图形和游戏开发---一 笛卡尔坐标系1.1 一维数学有理数是可数的（与自然数一一对应），实数是不可数的。自然数和整数的研究成为离散数学（Discrete Mathematics）对实数的研究成为连续数学（Continuous Mathematics）计算机图形...'
---
# 一 笛卡尔坐标系
## 1.1 一维数学
